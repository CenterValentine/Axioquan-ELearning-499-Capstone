...
interface Lesson {
  ...
  is_preview: boolean;
  view_count: number;
  created_at: Date | string; // Accept both Date (from DB) and string (from server actions)
  updated_at: Date | string; // Accept both Date (from DB) and string (from server actions)
}
